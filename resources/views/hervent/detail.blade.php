    ...
    <div class="container">
      <div class="row">
        ...
        <tr>
              <td> &nbsp;</td>
              <td> &nbsp;</td>
              <td align="right"><font color="black"> {{ $hervent->editcode }} {{ $hervent->id }}/<?php
 $tgl=date('m');
 echo $tgl;
 ?>/<?php
 $tgl=date('Y');
...
<tr>
              <td align="left">&nbsp;<font color="black"> {{ $hervent->item11 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->qty11 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->harga11}}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->amount11 }}</font></td>
</tr>
<tr>
              <td align="left">&nbsp;<font color="black"> {{ $hervent->item12 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->qty12 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->harga12}}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->amount12 }}</font></td>
</tr>
<tr>
              <td align="left">&nbsp;<font color="black"> {{ $hervent->item13 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->qty13 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->harga13}}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->amount13 }}</font></td>
</tr>
<tr>
              <td align="left">&nbsp;<font color="black"> {{ $hervent->item14 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->qty14 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->harga14}}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->amount14 }}</font></td>
</tr>
<tr>
              <td align="left">&nbsp;<font color="black"> {{ $hervent->item15 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->qty15 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->harga15}}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->amount15 }}</font></td>
</tr>
<tr>
              <td align="left">&nbsp;<font color="black"> {{ $hervent->item15 }}</font></td>
              <td align="right">  &nbsp;<font color="black"> {{ $hervent->qty15 }}</font></td>
...
<br>
                    ...
                    <a href="/download_invoice"  target="_blank" class="btn btn-dark">Save</a>
